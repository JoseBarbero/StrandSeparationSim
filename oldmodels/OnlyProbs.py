...
def onlyprobs():
    ...
    probs.add(Dense(1024, activation="relu"))
    probs.add(Dropout(0.5))
    probs.add(Dense(1, activation="sigmoid"))

    probs.compile(optimizer='adam',
...
if __name__ == "__main__":
    ...
    with open(log_file, 'w') as f:
        with redirect_stdout(f):
            ...
            print("Train results:")
            test_results(X_train_cnn, y_train, model)
            print("Test results:")
            test_results(X_test_cnn, y_test, model)
