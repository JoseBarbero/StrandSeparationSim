...
def cnnxlstm_allprobs(seqshape, opn_shape, bub8_shape, bub10_shape, bub12_shape, vrnorm_shape):
    ...
    opn_out = Dense(1024, activation = 'relu')(opn_x)
    ...
    bub8_out = Dense(1024, activation = 'relu')(bub8_x)
    ...
    bub10_out = Dense(1024, activation = 'relu')(bub10_x)
    ...
    bub12_out = Dense(1024, activation = 'relu')(bub12_x)
    ...
    vrnorm_x = Conv2D(filters=32, kernel_size=3, data_format='channels_last', strides=1, activation='relu')(vrnorm_x)
    # vrnorm_x = MaxPooling2D(2)(vrnorm_x)
    # vrnorm_x = Conv2D(filters=32, kernel_size=3, strides=1, activation='relu')(vrnorm_x)
    # vrnorm_x = MaxPooling2D(2)(vrnorm_x)
    # vrnorm_x = Conv2D(filters=32, kernel_size=3, strides=1, activation='relu')(vrnorm_x)
    # vrnorm_x = MaxPooling2D(2)(vrnorm_x)
    vrnorm_x = Flatten()(vrnorm_x)
    # vrnorm_x = MultiHeadAttention(num_heads=2, key_dim=2, attention_axes=(0))(vrnorm_x, vrnorm_x)
    vrnorm_out = Dense(1024, activation = 'relu')(vrnorm_x)
