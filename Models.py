...
def cnnxlstm_allprobs(seqshape, opn_shape, bub8_shape, bub10_shape, bub12_shape, vrnorm_shape):
    ...
    opn_x = Conv2D(filters=32, kernel_size=4, data_format='channels_last', strides=1, activation='relu')(opn_x)
    opn_x = MaxPooling2D(2)(opn_x)
    opn_x = Conv2D(filters=32, kernel_size=4, strides=1, activation='relu')(opn_x)
    opn_x = MaxPooling2D(2)(opn_x)
    opn_x = Conv2D(filters=32, kernel_size=4, strides=1, activation='relu')(opn_x)
    opn_x = MaxPooling2D(2)(opn_x)
    opn_x = Flatten()(opn_x)
    opn_x = MultiHeadAttention(num_heads=2, key_dim=2, attention_axes=(0))(opn_x, opn_x)
    opn_x = Dense(128, activation = 'relu')(opn_x)
    ...
    bub8_x = Conv2D(filters=32, kernel_size=4, data_format='channels_last', strides=1, activation='relu')(bub8_x)
    bub8_x = MaxPooling2D(2)(bub8_x)
    bub8_x = Conv2D(filters=32, kernel_size=4, strides=1, activation='relu')(bub8_x)
    bub8_x = MaxPooling2D(2)(bub8_x)
    bub8_x = Conv2D(filters=32, kernel_size=4, strides=1, activation='relu')(bub8_x)
    bub8_x = MaxPooling2D(2)(bub8_x)
    bub8_x = Flatten()(bub8_x)
    bub8_x = MultiHeadAttention(num_heads=2, key_dim=2, attention_axes=(0))(bub8_x, bub8_x)
    bub8_x = Dense(128, activation = 'relu')(bub8_x)
    ...
    bub10_x = Conv2D(filters=32, kernel_size=4, data_format='channels_last', strides=1, activation='relu')(bub10_x)
    bub10_x = MaxPooling2D(2)(bub10_x)
    bub10_x = Conv2D(filters=32, kernel_size=4, strides=1, activation='relu')(bub10_x)
    bub10_x = MaxPooling2D(2)(bub10_x)
    bub10_x = Conv2D(filters=32, kernel_size=4, strides=1, activation='relu')(bub10_x)
    bub10_x = MaxPooling2D(2)(bub10_x)
    bub10_x = Flatten()(bub10_x)
    bub10_x = MultiHeadAttention(num_heads=2, key_dim=2, attention_axes=(0))(bub10_x, bub10_x)
    bub10_x = Dense(128, activation = 'relu')(bub10_x)
    ...
    bub12_x = Conv2D(filters=32, kernel_size=4, data_format='channels_last', strides=1, activation='relu')(bub12_x)
    bub12_x = MaxPooling2D(2)(bub12_x)
    bub12_x = Conv2D(filters=32, kernel_size=4, strides=1, activation='relu')(bub12_x)
    bub12_x = MaxPooling2D(2)(bub12_x)
    bub12_x = Conv2D(filters=32, kernel_size=4, strides=1, activation='relu')(bub12_x)
    bub12_x = MaxPooling2D(2)(bub12_x)
    bub12_x = Flatten()(bub12_x)
    bub12_x = MultiHeadAttention(num_heads=2, key_dim=2, attention_axes=(0))(bub12_x, bub12_x)
    bub12_x = Dense(128, activation = 'relu')(bub12_x)
    ...
    vrnorm_x = Conv2D(filters=32, kernel_size=4, data_format='channels_last', strides=1, activation='relu')(vrnorm_x)
    vrnorm_x = MaxPooling2D(2)(vrnorm_x)
    vrnorm_x = Conv2D(filters=32, kernel_size=4, strides=1, activation='relu')(vrnorm_x)
    vrnorm_x = MaxPooling2D(2)(vrnorm_x)
    vrnorm_x = Conv2D(filters=32, kernel_size=4, strides=1, activation='relu')(vrnorm_x)
    vrnorm_x = MaxPooling2D(2)(vrnorm_x)
    vrnorm_x = Flatten()(vrnorm_x)
    vrnorm_x = MultiHeadAttention(num_heads=2, key_dim=2, attention_axes=(0))(vrnorm_x, vrnorm_x)
    vrnorm_x = Dense(128, activation = 'relu')(vrnorm_x)
